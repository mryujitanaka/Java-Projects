import etapaPlanejamento.PlantaCasa;
...
public class Casa {
    public static void main(String[] args) {
        ...
        System.out.println("Soma da metragem: " + resultado);

        System.out.println("NOVAS CARACTERÍSTICAS DA CASA: ");

        casa.mudarCorCasa("Branco");

        casa.mudarCaracteristicasCasa(200, 5, 6, "Madeira");
    }
}